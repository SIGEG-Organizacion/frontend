        ...
        <form onSubmit={handleSubmit}>
          <Stack spacing={3}>
            ...
            <FormControl fullWidth required>
              ...
              >
                <MenuItem value="technical">{t('support.report.categories.technical')}</MenuItem>
                <MenuItem value="access">{t('support.report.categories.access')}</MenuItem>
                <MenuItem value="data">{t('support.report.categories.data')}</MenuItem>
                <MenuItem value="other">{t('support.report.categories.other')}</MenuItem>
              </Select>
            </FormControl>
            ...
            <FormControl fullWidth>
              ...
              <Select
                ...
                onChange={handleSelectChange}
              >
                <MenuItem value="low">{t('support.report.priorities.low')}</MenuItem>
                <MenuItem value="medium">{t('support.report.priorities.medium')}</MenuItem>
                <MenuItem value="high">{t('support.report.priorities.high')}</MenuItem>
              </Select>
            </FormControl>
